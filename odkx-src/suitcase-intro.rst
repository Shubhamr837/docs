...
Suitcase remembers the last username and server url entered. You can check the “save password” option to keep yourself logged in when you open the application again. To log out of the application you can use the logout button on the top right of the download tab.
